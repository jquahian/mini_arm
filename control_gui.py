...
layout = [[sg.Button('Connect')],
          ...
          [sg.Text('X:'), sg.Input(point_coordinates[0])],
...
while True:
    ...
    if event == 'Calibrate All':
        ...
        controller.move_axis_absolute(0, 0, 5, limit.single_angle_limit_check(1, joint_angles[0]))
        controller.move_axis_absolute(0, 1, 5, limit.single_angle_limit_check(2, joint_angles[1]))
        controller.move_axis_absolute(1, 0, -5, limit.single_angle_limit_check(3, joint_angles[2]))
        controller.move_axis_absolute(1, 1, 1, limit.single_angle_limit_check(4, joint_angles[3]))

    if event == 'Home All':
        controller.move_axis_absolute(0, 0, 5, limit.single_angle_limit_check(1, 0))
        controller.move_axis_absolute(0, 1, 5, limit.single_angle_limit_check(1, 0))
        controller.move_axis_absolute(1, 0, -5, limit.single_angle_limit_check(1,0))
        controller.move_axis_absolute(1, 1, 1, limit.single_angle_limit_check(1, 0))
